...
public class HUD extends GuiIngame
{
    ...
    private void drawHUD() {
        ...
        else if (this.getSetting("Title Mode", false).getCurrentMode().equalsIgnoreCase("Revamp") && this.getSetting("Arraylist Mode", false).getCurrentMode().equalsIgnoreCase("Clean")) {
            information = "Clevamp";
        }
        else if (this.getSetting("Title Mode", false).getCurrentMode().equalsIgnoreCase("Revamp") && this.getSetting("Arraylist Mode", false).getCurrentMode().equalsIgnoreCase("Stacking")) {
            information = "Stackvamp";
        }
        else if (this.getSetting("Title Mode", false).getCurrentMode().equalsIgnoreCase("Skeet") && this.getSetting("Arraylist Mode", false).getCurrentMode().equalsIgnoreCase("Clean")) {
            information = "Cleet";
        }
        ...
        else if (this.getSetting("Title Mode", false).getCurrentMode().equalsIgnoreCase("Skeet") && this.getSetting("Arraylist Mode", false).getCurrentMode().equalsIgnoreCase("Jello")) {
            information = "Skello";
        }
        else if (this.getSetting("Title Mode", false).getCurrentMode().equalsIgnoreCase("Skeet") && this.getSetting("Arraylist Mode", false).getCurrentMode().equalsIgnoreCase("Stacking")) {
            information = "Stackeet";
        }
        else if (this.getSetting("Title Mode", false).getCurrentMode().equalsIgnoreCase("Jello") && this.getSetting("Arraylist Mode", false).getCurrentMode().equalsIgnoreCase("Stacking")) {
            information = "Jellcking";
        }
        else if (this.getSetting("Title Mode", false).getCurrentMode().equalsIgnoreCase("Jello") && this.getSetting("Arraylist Mode", false).getCurrentMode().equalsIgnoreCase("Revamp")) {
            information = "Rello";
        }
        else if (this.getSetting("Title Mode", false).getCurrentMode().equalsIgnoreCase("Jello") && this.getSetting("Arraylist Mode", false).getCurrentMode().equalsIgnoreCase("Clean")) {
            information = "Clello";
        }
        else {
            information = "N/A";
