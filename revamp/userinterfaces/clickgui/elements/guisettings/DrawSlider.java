...
public class DrawSlider extends Element
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawRect(this.x, this.y + this.height - 3, (int)(this.x + currentValue * this.width), this.y + this.height - 1, Element.getSetting(Element.moduleName("ClickGUI"), "Rainbow").isToggled() ? Rainbow.rainbow(4.0f, 0.5f, 1.0f, 200L) : Revamp.getClientCOLOR().getRGB());
        if (this.dragging) {
