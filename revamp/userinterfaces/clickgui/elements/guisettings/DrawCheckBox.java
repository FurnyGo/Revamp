...
public class DrawCheckBox extends Element
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawRect(this.x + 2, this.y + 2, this.x + 2 + this.height - 4, this.y + this.height - 2, this.setting.isToggled() ? (Element.getSetting(Element.moduleName("ClickGUI"), "Rainbow").isToggled() ? Rainbow.rainbow(4.0f, 0.5f, 1.0f, 200L) : Revamp.getClientCOLOR().getRGB()) : -15724528);
