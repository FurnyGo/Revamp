...
public class DrawCategory
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawRect(this.x - 3, this.y, this.x + 100 + 3, this.y + this.height, Element.getSetting(Element.moduleName("ClickGUI"), "Rainbow").isToggled() ? Rainbow.rainbow(4.0f, 0.5f, 1.0f, 200L) : this.category.getCategoryColor());
        this.fr.drawStringWithShadow(this.category.name().toLowerCase(), (float)this.x, this.y + this.height / 2 - this.fr.FONT_HEIGHT / 2 + 1, -1);
        this.fr.drawStringWithShadow(this.extended ? "-" : "+", (float)(this.x + 100 - this.fr.getStringWidth(this.extended ? "-" : "+")), this.y + this.height / 2 - this.fr.FONT_HEIGHT / 2 + 1, -1);
