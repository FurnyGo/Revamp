...
import revamp.modules.impl.render.Radar;
import revamp.modules.impl.world.Timer;
import revamp.modules.impl.targets.Mobs;
import revamp.modules.impl.combat.Refill;
...
import revamp.modules.impl.combat.AimAssist;
...
public class ModuleManager
{
    ...
    public ModuleManager() {
        (this.modules = new ArrayList<Module>()).addAll(Arrays.asList(new MurderMystery(), new InventoryMove(), new NameProtect(), new ScoreboardModule(), new InventoryManager(), new NoSlowdown(), new AutoClicker(), new AimAssist(), new ItemPhysics(), new FastLadder(), new KeepSprint(), new NoHurtCam(), new TargetHUD(), new Animations(), new FastPlace(), new AutoTool(), new Fullbright(), new NameTags(), new Invisibles(), new Ambience(), new SafeWalk(), new AutoArmor(), new Scaffold(), new Hitboxes(), new Criticals(), new Spammer(), new Killsults(), new Players(), new Friends(), new Velocity(), new ClickGUI(), new Stealer(), new Animals(), new Others(), new Fucker(), new AntiBot(), new Sprint(), new Speed(), new Panic(), new Reach(), new NoFall(), new Teams(), new Eagle(), new Flight(), new Refill(), new Mobs(), new Timer(), new Radar(), new Aura(), new Step(), new Cape(), new HUDModule(), new ESP()));
    }
