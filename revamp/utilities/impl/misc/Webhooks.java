...
public class Webhooks
{
    ...
    public Webhooks(final String url) {
    ...
    public void execute() throws IOException {
        ...
        final JSONObject json = new JSONObject((JSONObject)null);
        ...
        if (!this.embeds.isEmpty()) {
            ...
            for (final EmbedObject embed : this.embeds) {
                final JSONObject jsonEmbed = new JSONObject((JSONObject)null);
                ...
                if (footer != null) {
                    final JSONObject jsonFooter = new JSONObject((JSONObject)null);
                    jsonFooter.put("text", footer.getText());
                    jsonFooter.put("icon_url", footer.getIconURL());
                    jsonEmbed.put("footer", jsonFooter);
                }
                if (image != null) {
                    final JSONObject jsonImage = new JSONObject((JSONObject)null);
                    jsonImage.put("url", image.getURL());
                    jsonEmbed.put("image", jsonImage);
                }
                if (thumbnail != null) {
                    final JSONObject jsonThumbnail = new JSONObject((JSONObject)null);
                    jsonThumbnail.put("url", thumbnail.getURL());
                    jsonEmbed.put("thumbnail", jsonThumbnail);
                }
                if (author != null) {
                    final JSONObject jsonAuthor = new JSONObject((JSONObject)null);
                ...
                for (final EmbedObject.Field field : fields) {
                    final JSONObject jsonField = new JSONObject((JSONObject)null);
