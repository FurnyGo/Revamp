...
public class Rainbow
{
    ...
    public static int breath(final double seconds, final double offset, final double size1, final double size2, final Color color) {
        final double hue = size1 - Math.abs(Math.sin(System.currentTimeMillis() / 1.0E8 * seconds * 400000.0 + offset * 0.45)) / 2.0 + size2;
